...
DATA_DIR = os.path.join(BASE_DIR, "..", "..", "data", "snapshot")
PLOTS_DIR = os.path.join(BASE_DIR, "..", "..", "results", "plots_snapshot")
...
def set_output_dirs(suffix):
    ...
    if suffix:
        DATA_DIR = os.path.join(BASE_DIR, "..", "..", "data", f"snapshot_{suffix}")
        PLOTS_DIR = os.path.join(BASE_DIR, "..", "..", "results", f"plots_snapshot_{suffix}")
